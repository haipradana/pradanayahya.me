...
<div class="max-w-4xl lg:max-w-5xl mx-auto px-7 lg:px-8 py-16 lg:py-20">
  ...
  <section class="text-center mb-10 lg:mb-14">
    <div class="w-32 h-32 lg:w-40 lg:h-40 mx-auto mb-4 lg:mb-6 rounded-full bg-gradient-to-br from-gray-400 to-gray-600 p-1">
      <img 
