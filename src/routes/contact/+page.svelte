...
<div class="max-w-2xl mx-auto px-20 py-16">
  <!-- Header -->
  <section class="text-center mb-16">
    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-gray-50 mb-8">
      Reach Me!
    </h1>
  </section>
  ...
  <section class="space-y-8">
    ...
    <div class="flex items-center justify-start">
      <a
        ...
        class="flex items-center space-x-3 text-lg text-gray-700 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 transition-colors group"
      >
        <div class="p-2 bg-red-100 dark:bg-red-900/20 rounded-lg group-hover:bg-red-200 dark:group-hover:bg-red-900/30 transition-colors">
          <Mail class="w-5 h-5 text-red-600 dark:text-red-400" />
        </div>
        <span class="underline">pradanayahyaabdillah@mail.ugm.ac.id</span>
      </a>
    </div>
    ...
    <div class="flex items-center justify-start">
      <a
        ...
        class="flex items-center space-x-3 text-lg text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-500 transition-colors group"
      >
        <div class="p-2 bg-blue-100 dark:bg-blue-900/20 rounded-lg group-hover:bg-blue-200 dark:group-hover:bg-blue-900/30 transition-colors">
          <User class="w-5 h-5 text-blue-700 dark:text-blue-500" />
        </div>
    ...
    <div class="flex items-center justify-start">
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        class="flex items-center space-x-3 text-lg text-gray-700 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-200 transition-colors group"
      >
        <div class="p-2 bg-gray-100 dark:bg-gray-900/20 rounded-lg group-hover:bg-gray-200 dark:group-hover:bg-gray-900/30 transition-colors">
          <Github class="w-5 h-5 text-gray-800 dark:text-gray-200" />
        </div>
    ...
    <div class="flex items-center justify-start">
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        class="flex items-center space-x-3 text-lg text-gray-700 dark:text-gray-300 hover:text-yellow-500 dark:hover:text-yellow-400 transition-colors group"
      >
        <div class="p-2 bg-yellow-100 dark:bg-yellow-900/20 rounded-lg group-hover:bg-yellow-200 dark:group-hover:bg-yellow-900/30 transition-colors">
          <svg class="w-5 h-5 text-yellow-600 dark:text-yellow-400" viewBox="0 0 24 24" fill="currentColor">
