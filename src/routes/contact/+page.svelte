...
<svelte:head>
  ...
  <meta name="description" content="Get in touch with Pradana Yahya - Developer and Tech Enthusiast" />
</svelte:head>

<div class="max-w-2xl mx-auto px-6 sm:px-20 py-8 sm:py-16">
  <!-- Header -->
  <section class="text-center mb-8 sm:mb-16">
    <h1 class="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-900 dark:text-gray-50 mb-4 sm:mb-8">
      Reach Me!
    </h1>
  </section>
  ...
  <section class="space-y-4 sm:space-y-8">
    ...
    <div class="flex items-center justify-start">
      ...
      >
        <div class="p-1.5 sm:p-2 bg-red-100 dark:bg-red-900/20 rounded-lg group-hover:bg-red-200 dark:group-hover:bg-red-900/30 transition-colors">
          <Mail class="w-4 h-4 sm:w-5 sm:h-5 text-red-600 dark:text-red-400" />
        </div>
        <span class="underline break-all sm:break-normal">pradanayahyaabdillah@mail.ugm.ac.id</span>
      </a>
    </div>
    ...
    <div class="flex items-center justify-start">
      ...
      >
        <div class="p-1.5 sm:p-2 bg-gray-100 dark:bg-gray-900/20 rounded-lg group-hover:bg-gray-200 dark:group-hover:bg-gray-900/30 transition-colors">
          <Github class="w-4 h-4 sm:w-5 sm:h-5 text-gray-800 dark:text-gray-200" />
        </div>
    ...
    <div class="flex items-center justify-start">
      ...
      >
        <div class="p-1.5 sm:p-2 bg-yellow-100 dark:bg-yellow-900/20 rounded-lg group-hover:bg-yellow-200 dark:group-hover:bg-yellow-900/30 transition-colors">
          <svg class="w-4 h-4 sm:w-5 sm:h-5 text-yellow-600 dark:text-yellow-400" viewBox="0 0 24 24" fill="currentColor">
